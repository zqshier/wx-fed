...
import { GoodsInfo, GoodsInfoSkusItem } from '@/dto/goods';
...
const handleOpenPoster = () => {
  // emits('update:showPoster', true);
  emits('track', '微信朋友圈');
  Taro.preload({ type: `${posterSource.normalGoods}`, goodsInfo: props.data, cSkusData: props.skusData });
  Taro.navigateTo({
